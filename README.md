...
By the time the fifth family lived in this house, it had grown to a substantial size but was still a functional and recognizable house. They were an odd family, to say the least. There was something about the
...
* Concrete ideas for clues and keys for player progression (~6 weeks, ongoing over all sprints)
   ...
   * How the different puzzles will be set up and what clues will be provided to help the player understand how to complete the puzzle *Start adding story elements to the game (~6 weeks, goes along with clues and keys)
